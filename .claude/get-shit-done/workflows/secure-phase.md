...
```
Agent(
  prompt="Read /Users/mrasoahaingo/Projects/perso/next-esn/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mrasoahaingo/Projects/perso/next-esn/.claude/get-shit-done/templates/SECURITY.md`
