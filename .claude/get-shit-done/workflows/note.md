...
- **Global scope**: `/Users/mrasoahaingo/Projects/perso/next-esn/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mrasoahaingo/Projects/perso/next-esn/.claude/notes/`)
...
2. Glob `/Users/mrasoahaingo/Projects/perso/next-esn/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mrasoahaingo/Projects/perso/next-esn/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mrasoahaingo/Projects/perso/next-esn/.claude/notes/` — works in any directory
